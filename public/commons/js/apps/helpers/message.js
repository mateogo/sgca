...
DocManager.module("Message", function(Messages, DocManager, Backbone, Marionette, $, _){
  ...
  var notify = function(str,type,icon){
   ...
   var inlineImpl = {
      success: function(str){
        return this.notify(str,'success','glyphicon glyphicon-ok');
      },
      info: function(str){
        return this.notify(str,'info','glyphicon glyphicon-info-sign');
      },
      warning: function(str){
        return this.notify(str,'warning','glyphicon glyphicon-warning-sign');
      },
      error: function(str){
          return this.notify(str,'danger','glyphicon glyphicon-warning-sign');
      },
