window.utils = {
    ...
    //========= BUDGET TEMPLATE =========================
    tipoBudgetMovimList: [
        {val:'no_definido',      tmplate:'',  label:'Tipo de movimiento'},
        {val:'global',           tmplate:'tecnica',  label:'Global'},
        {val:'artistica',        tmplate:'artistica',  label:'Artística'},
        {val:'tecnica',          tmplate:'tecnica',  label:'Técnica'},
        {val:'viaje',            tmplate:'tecnica',  label:'Viajes'},
        {val:'evento',           tmplate:'tecnica',  label:'Eventos'},
        {val:'tecnologia',       tmplate:'tecnica',  label:'Tecnología'},
        {val:'biendeuso',        tmplate:'tecnica',  label:'Bienes de Uso'},
        {val:'bconsumible',      tmplate:'tecnica',  label:'Bienes Consumibles'},
        {val:'compras',          tmplate:'tecnica',  label:'Otras compras'},
        {val:'grafica',          tmplate:'tecnica',  label:'Gráfica'},
        {val:'publicaciones',    tmplate:'tecnica',  label:'Publicaciones'},
        {val:'capacitacion',     tmplate:'tecnica',  label:'Capacitación'},
        {val:'alquileres',       tmplate:'tecnica',  label:'Alquileres'},
        {val:'servicios',        tmplate:'tecnica',  label:'Otros servicios'},
        {val:'contratos',        tmplate:'tecnica',  label:'Contratos'},
        {val:'pasajes',          tmplate:'tecnica',  label:'Pasajes'},
        {val:'viaticos',         tmplate:'tecnica',  label:'Viáticos'},
        {val:'estadias',         tmplate:'tecnica',  label:'Estadías'},
        {val:'catering',         tmplate:'tecnica',  label:'Catering'},
        {val:'traslados',        tmplate:'tecnica',  label:'Traslados'},
        {val:'conectividad',     tmplate:'tecnica',  label:'Conectividad'},
        {val:'servbasicos',      tmplate:'tecnica',  label:'Servicios Básicos'},
        {val:'infraestructura',  tmplate:'tecnica',  label:'Infraestructura'},
    ],

    budgetTemplateList:['global'],

    budgetTemplate:{
        global:[
            {val:'no_definido', label:'Subtipo de Gasto',  ume:'',  cgasto:'101.000',  template:'1', classattr:'info'},
            {val:'artistica',   label:'Artista',           ume:'artista',    cgasto:'101.101',  template:'1', classattr:'info'},
            {val:'tecnica',     label:'Técnica',           ume:'tecnica',    cgasto:'101.101',  template:'1', classattr:'info'},
            {val:'grafica',     label:'Gráfica',           ume:'grafica',    cgasto:'101.101',  template:'1', classattr:'info'},
            {val:'viajes',      label:'Viajes',            ume:'viaje',      cgasto:'101.101',  template:'1', classattr:'info'},
            {val:'alquileres',  label:'Alquileres',        ume:'alquiler',   cgasto:'101.101',  template:'1', classattr:'info'},
            {val:'buso',        label:'Bienes de Uso',     ume:'buso',       cgasto:'101.101',  template:'1', classattr:'info'},
            {val:'consumibles', label:'Consumibles',       ume:'consumible', cgasto:'101.101',  template:'1', classattr:'info'},
            {val:'loc',         label:'Locación de Obra',  ume:'contrato',   cgasto:'101.101',  template:'1', classattr:'info'},
        ],
        artistica:[
            {val:'no_definido', label:'Subtipo de Gasto',    ume:'',  cgasto:'101.000',  template:'1', classattr:'info'},
            {val:'artista-a',   label:'Artista A',           ume:'artista',  cgasto:'101.101',  template:'1', classattr:'info'},
            {val:'artista-b',   label:'Artista B',           ume:'artista',  cgasto:'101.101',  template:'1', classattr:'info'},
            {val:'artista-c',   label:'Artista C',           ume:'artista',  cgasto:'101.101',  template:'1', classattr:'info'},
            {val:'prodintgrl',  label:'Producción Integral', ume:'produccion',  cgasto:'101.101',  template:'1', classattr:'info'},
        ],
        tecnica:[
            {val:'no_definido', label:'Subtipo de Gasto',      ume:'',  cgasto:'102.000',  template:'1', classattr:'info'},
            {val:'tecnica-a',   label:'Técnica A',             ume:'tecnica',  cgasto:'102.102',  template:'1', classattr:'info'},
            {val:'tecnica-b',   label:'Técnica B',             ume:'tecnica',  cgasto:'102.102',  template:'1', classattr:'info'},
            {val:'tecnica-c',   label:'Técnica C',             ume:'tecnica',  cgasto:'102.101',  template:'1', classattr:'info'},
            {val:'escenario',   label:'Escenario y vallados',  ume:'escenario',  cgasto:'101.101',  template:'1', classattr:'info'},
            {val:'lucese',      label:'Luces escenario',       ume:'lucese',  cgasto:'101.101',  template:'1', classattr:'info'},
            {val:'pantallae',   label:'Pantalla escenario',    ume:'pantallae',  cgasto:'101.101',  template:'1', classattr:'info'},
            {val:'energiae',    label:'Energía escenario',     ume:'energiae',  cgasto:'101.101',  template:'1', classattr:'info'},
            {val:'backline',    label:'Back line',             ume:'backline',  cgasto:'101.101',  template:'1', classattr:'info'},
            {val:'sonidocine',  label:'Sonido cine',           ume:'sonidoc',  cgasto:'101.101',  template:'1', classattr:'info'},
            {val:'proyectores', label:'Proyectores',           ume:'proyector',  cgasto:'101.101',  template:'1', classattr:'info'},
        ],
