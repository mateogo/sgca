DocManager.module("LoginApp.Common.Views", function(Views, DocManager, Backbone, Marionette, $, _){

  Views.FormLogin = Marionette.ItemView.extend({
    ...
    onRender: function(){
      var self = this;
      console.log('LoginForm Views RENDER')
    ...
    initialize: function(opts){
      console.log('LoginFormVIEWS INIT')
