DocManager.module("SalonRequestApp.Edit", function(Edit, DocManager, Backbone, Marionette, $, _){
  ...
  Edit.Layout = Marionette.LayoutView.extend({
    ...
    regions: {
      ...
      navigateRegion: '#salon-open-forms',
    },
  ...
  Edit.WizardLayout = Marionette.LayoutView.extend({
    ...
    getTemplate: function(){
      return utils.templates.SalonMovLayout;
    },
    ...
    termsOfUse: function(e){
      ...
      DocManager.confirm(utils.templates.SalonTerminosYCondiciones(),{okText: 'Aceptar', cancelText: 'cancelar'}).done(function(){
  ...
  //*************************************************************
  Edit.StepOneForm = DocManager.SalonRequestApp.Common.Views.Form.extend({
    whoami: 'StepOneForm',    
    getTemplate: function(){
      return utils.templates.SalonMov01Form;
    },
  ...
  Edit.StepTwoLayout = Marionette.LayoutView.extend({
    ...
    getTemplate: function(){
      return utils.templates.SalonMov02Layout;
    },
  ...
  //*************************************************************
  Edit.StepTwoForm = DocManager.SalonRequestApp.Common.Views.Form.extend({
    whoami: 'StepTwoForm',
    
    getTemplate: function(){
      return utils.templates.SalonMov02Form;
    },
    ...
    onRender: function(){
      ...
      if(self.model.get('etipojuridico') === 'pfisica') self.$('.togglejuridica').addClass('hidden');
      if(self.model.get('salon2015') === 'no') self.$('#salon-detail').addClass('hidden');
  ...
  //*************************************************************
  Edit.StepThreeDeprecatedLayout = Marionette.LayoutView.extend({
    ...
    getTemplate: function(){
      return utils.templates.SalonMov03Layout;
    },
    onRender: function(){
      var self = this;
  ...
  Edit.StepThreeDeprecatedForm = DocManager.SalonRequestApp.Common.Views.Form.extend({
